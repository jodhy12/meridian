...
async function runSafetyChecks(name, args) {
  switch (name) {
    case "deploy_position": {
      ...
      // Hard-skip rules: mechanically clear violations only (pump trap, overbought, no support)
      // Kept minimal — only rules with clear logical basis, not data-fitted thresholds.
      // Pattern A/B and bounce scoring moved to LLM guidance (sample sizes too small to hard-code).
      {
